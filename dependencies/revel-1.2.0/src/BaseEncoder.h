...
{
public:
    explicit Revel_BaseEncoder(const Revel_Params &params);
     ...
     */
    virtual Revel_Error EncodeStart(const char *filename);
...
protected:
    ...
    char *m_encodedFrame; /**< Buffer containing one frame's worth of encoded data. */
