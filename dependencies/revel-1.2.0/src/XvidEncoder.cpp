...
Revel_XvidEncoder::Revel_XvidEncoder(const Revel_Params &params) : Revel_BaseEncoder(params)
{
...
Revel_Error Revel_XvidEncoder::EncodeStart(const char *filename)
{
    Revel_Error revError = Revel_BaseEncoder::EncodeStart(filename);
